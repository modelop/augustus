...
"""This module defines the FALSE class."""

from augustus.core.NumpyInterface import NP
from augustus.core.PmmlPredicate import PmmlPredicate

class FALSE(PmmlPredicate):
    """FALSE implements the PMML False predicate, which always returns
    false (all-caps name avoids Python name conflict).

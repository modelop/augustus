...
"""This module defines the BaselineModel for custom ODG PMML."""

from augustus.pmml.model.baseline.BaselineModelWithState import BaselineModelWithState as BaselineModel

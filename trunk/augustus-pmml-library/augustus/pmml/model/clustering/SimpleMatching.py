...
"""This module defines the SimpleMatching class."""

from augustus.core.NumpyInterface import NP
from augustus.pmml.model.clustering.PmmlClusteringMetricBinary import PmmlClusteringMetricBinary

class SimpleMatching(PmmlClusteringMetricBinary):
    """The SimpleMatching metric is a simple binary similarity metric."""

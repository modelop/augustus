...
"""This module defines the Tanimoto class."""

from augustus.core.NumpyInterface import NP
from augustus.pmml.model.clustering.PmmlClusteringMetricBinary import PmmlClusteringMetricBinary

class Tanimoto(PmmlClusteringMetricBinary):
    """The Tanimoto metric is an alternative metric for binary similarity."""
    ...
    def finalizeDistance(self, state, adjustM, distributionBased, covarianceMatrix):
        ...
        return NP(NP(state.a11 + state.a00) / NP(NP(state.a11 + NP(NP(state.a10 + state.a01) * 2.0)) + state.a00))

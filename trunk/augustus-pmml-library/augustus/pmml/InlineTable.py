...
"""This module defines the InlineTable class."""

from augustus.core.PmmlBinding import PmmlBinding
from augustus.core.TableInterface import TableInterface

class InlineTable(PmmlBinding, TableInterface):
    """InlineTable implements an XML table embedded within the PMML
    document.
    ...
    def iterate(self):
        ...
        return self.iterateOverMemory(self)

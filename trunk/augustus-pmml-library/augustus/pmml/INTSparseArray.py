...
"""This module defines the INTSparseArray class."""
...
class INTSparseArray(PmmlArray):
    """INTSparseArray implements a sparse array of integer constants.
    ...
    def values(self, convertType=False):
        ...
        entries = self.childOfTag("INT-Entries")
        ...
        if entries is None:
            ...
            if convertType:
                entries = map(int, entries.text.strip().split())
            else:

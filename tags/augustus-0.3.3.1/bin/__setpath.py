...
#print sys.path
#x=input()
#sys.path.insert(1,os.path.join(_basedir,'src'))
#sys.path.insert(1,os.path.join(_basedir,'config'))
# these are intended for PROJDIR
#CONFIGDIR=os.path.join(_basedir,'config')
#DATADIR=os.path.join(_basedir,'data')
#PMMLDIR=os.path.join(_basedir,'pmml')
del os,sys,dn,_basedir
__all__=()
#__all__ =("DATADIR","CONFIGDIR","PMMLDIR")

import sys
from numpy.core.numerictypes import string_, unicode_, integer, object_
from numpy.core.numeric import ndarray, broadcast, empty, compare_chararrays
...
class chararray(ndarray):
    ...
    def __getitem__(self, obj):
        ...
        if isinstance(val, (string_, unicode_)):
            #print 'I wont strip now!'
            try:
                temp = val[1] + val[1:].rstrip()
            except IndexError:
                temp = val
            temp = val
            #temp = val.rstrip()

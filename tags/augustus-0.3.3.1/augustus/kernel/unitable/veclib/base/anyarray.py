...
from augustus.external import numarray as na
from augustus.external.numarray import strings as nastr

as_num_array = na.asarray
as_char_array = nastr.asarray
base_any_array = na.NDArray
base_num_array = na.NumArray
base_char_array = nastr.RawCharArray
...
def is_num_array(x): return isinstance(x,base_num_array)
def is_char_array(x): return isinstance(x,base_char_array)

...
class ConsumerRuleSetModel(ConsumerAlgorithm):
    ...
    def score(self, syncNumber, get):
        ...
        return {SCORE_predictedValue: score, SCORE_weight: weight, SCORE_entityId: entityId}
...
class ProducerRuleSetModel(ProducerAlgorithm):
    def initialize(self, **params):
        raise Exception, "RuleSetModel does not have a dedicated producer; use the TreeModelProducer on rule-sets instead"

...
producerAlgorithmMap = {
    pmml.BaselineModel:   augustus.algorithms.baseline.ProducerBaselineModel,
    pmml.ClusteringModel: augustus.algorithms.clustering.ProducerClusteringModel,
    pmml.TreeModel:       augustus.algorithms.trees.ProducerTreeModel,
    # ProducerTreeModel recognizes <RuleSetModel> elements and fills them appropriately
    pmml.RuleSetModel:    augustus.algorithms.trees.ProducerTreeModel,
    }
...
class Engine:
    ...
    def initialize(self, consumerParameters={}, producerParameters={}):
        ...
        if isinstance(self.pmmlModel, pmml.MiningModel):
            ...
            segmentRecord.consumerAlgorithm = consumerAlgorithmMap[self.pmmlModel.__class__](self, segmentRecord)
            segmentRecord.producerAlgorithm = producerAlgorithmMap[self.pmmlModel.__class__](self, segmentRecord)
        ...
        for segmentRecord in self.segmentRecords:
            segmentRecord.initialize(consumerParameters, producerParameters, existingSegment=True)
    ...
    def _makeSegmentRecord(self, pmmlSegment, autoSegment=False):
        ...
        segmentRecord.consumerAlgorithm = consumerAlgorithmMap[pmmlSubModel.__class__](self, segmentRecord)
        segmentRecord.producerAlgorithm = producerAlgorithmMap[pmmlSubModel.__class__](self, segmentRecord)

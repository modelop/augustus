...
class ProducerKMeans(ProducerAlgorithm):
    ...
    defaultParams = {"updateExisting": "false", "quickConvergeSteps": "()", "seedSource": "dataPoints", "numberOfTrials": "20", "numberToConverge": "5"}
    ...
    def produce(self):
        ...
        if self.logDebug:
            self.logger.debug("KMeansClustering.produce: this segment has %d data records; setting up for cluster production.")

...
class Reader(object):
  ...
  to the application."""
  def __init__(self, callback, classmap=None, source=None, logger=None, openwait=5, magicheader=True, unitable=False, autoattr=True, header=None, sep=None, types=None, ffConvert=None, framing=None):
